...
import PodcastSummary from '../ui/PodcastSummary';
...
describe('PodcastSummary', () => {
  it('check if podcastSummary  renders name', async () => {
    render(<PodcastSummary podcast={fakePodcast} />);
    const name = screen.getByText('Fake Podcast');
